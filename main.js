...
// an object for storing the user's saved states
...
$(document).ready(function() {
    ...
    // Run game when play clicked
    $('#play-button').click(function(event) {
	game.run();
    });

    // Pause game when pause clicked
    ...
    // restore a particular saved state
    ...
    // toggle a call on/off when clicked
